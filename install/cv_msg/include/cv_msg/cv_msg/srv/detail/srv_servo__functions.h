...
#ifndef CV_MSG__SRV__DETAIL__SRV_SERVO__FUNCTIONS_H_
#define CV_MSG__SRV__DETAIL__SRV_SERVO__FUNCTIONS_H_
...
/// Initialize srv/SrvServo message.
/**
...
/// Create srv/SrvServo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cv_msg__srv__SrvServo_Request__init().
...
/// Destroy srv/SrvServo message.
/**
 * It calls
 * cv_msg__srv__SrvServo_Request__fini()
...
/// Check for srv/SrvServo message equality.
/**
...
/// Initialize array of srv/SrvServo messages.
/**
...
/// Finalize array of srv/SrvServo messages.
/**
 * It calls
 * cv_msg__srv__SrvServo_Request__fini()
...
/// Create array of srv/SrvServo messages.
/**
 * It allocates the memory for the array and calls
 * cv_msg__srv__SrvServo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SrvServo messages.
/**
 * It calls
 * cv_msg__srv__SrvServo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SrvServo message array equality.
/**
...
/// Copy an array of srv/SrvServo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cv_msg__srv__SrvServo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cv_msg
...
/**
 * It calls
 * cv_msg__srv__SrvServo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cv_msg
...
/**
 * It allocates the memory for the array and calls
 * cv_msg__srv__SrvServo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cv_msg
...
/**
 * It calls
 * cv_msg__srv__SrvServo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CV_MSG__SRV__DETAIL__SRV_SERVO__FUNCTIONS_H_
