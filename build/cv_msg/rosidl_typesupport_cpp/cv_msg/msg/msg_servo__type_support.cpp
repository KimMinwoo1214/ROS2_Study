...
static const _MsgServo_type_support_symbol_names_t _MsgServo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cv_msg, msg, MsgServo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cv_msg, msg, MsgServo)),
  }
};
...
{
  return &::cv_msg::msg::rosidl_typesupport_cpp::MsgServo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cv_msg, msg, MsgServo)() {
  return get_message_type_support_handle<cv_msg::msg::MsgServo>();
}
