...
static const _SrvServo_Request_type_support_symbol_names_t _SrvServo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cv_msg, srv, SrvServo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cv_msg, srv, SrvServo_Request)),
  }
};
...
{
  return &::cv_msg::srv::rosidl_typesupport_cpp::SrvServo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cv_msg, srv, SrvServo_Request)() {
  return get_message_type_support_handle<cv_msg::srv::SrvServo_Request>();
}
...
static const _SrvServo_Response_type_support_symbol_names_t _SrvServo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cv_msg, srv, SrvServo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cv_msg, srv, SrvServo_Response)),
  }
};
...
{
  return &::cv_msg::srv::rosidl_typesupport_cpp::SrvServo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cv_msg, srv, SrvServo_Response)() {
  return get_message_type_support_handle<cv_msg::srv::SrvServo_Response>();
}
...
static const _SrvServo_type_support_symbol_names_t _SrvServo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cv_msg, srv, SrvServo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cv_msg, srv, SrvServo)),
  }
};
...
{
  return &::cv_msg::srv::rosidl_typesupport_cpp::SrvServo_service_type_support_handle;
}
